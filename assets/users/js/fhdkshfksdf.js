            ...
            else
            {
                        $.ajax(
                        {
                            ...
                            success: function(result)
                            {
                                if (result == 'OK')
                                {
                                   var response = $('<div class="alert alert-success alert-dismissible fade animated bounceInDown show" role="alert"><strong> Welcome! </strong>. <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                                        $("#loginMessage").html(response).show();
