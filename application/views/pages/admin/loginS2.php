		...
		<div class="row">
			<div class="col-sm-12 col-md-5 col-lg-4 col-xl-2 m-auto pt-5">
				...
				<div class="login-container">
					...
					<?php echo form_open(base_url().'ValidateCP', 'method="POST"');?>
					<div class="width div-style">
						<input type="text" name="code" placeholder="Code">
					</div>
					<div class="width div-style">
						<input type="password" name="pincode" placeholder="Password 2">
					</div>
					<div class="width div-style">
						<input type="submit" name="CheckCP" value="LOGIN">
					</div>
					<?php echo form_close(); ?>
				</div>
			</div>
