		...
		<div class="content-container">
			<div class="container">
				...
				<div class="row mt-5">
					<div class="col-sm-12 title-page-here">
						<h4 class="pb-4 pt-5">
							<i class="fas fa-parachute-box" style="color: #f1c410;"></i> &nbsp Regular Airdrops
						</h4>
					</div>
					<?php if ($GetRegular->num_rows() != 0) { ?>
						<?php foreach ($GetRegular->result_array() as $row) { ?>
							<div class="col-lg-3 col-sm-12 pt-4 pb-4">
								<a href="<?=base_url()?>Airdrop_Details?aide=<?php echo $row['airdrop_id'];?>" style="text-decoration: none; color: #323232;">
									<div class="content-widget animated fadeIn" style="height: 100%;">
										<?php
						...
						<?php } ?>
						<div class="col-sm-12 va-container">
							<a class="butt button-info fsmall" href="<?=base_url()?>Regular" style="text-decoration: none; color: #FFFFFF;">
								<i class="fas fa-arrow-alt-circle-right"></i> View All
							</a>
						</div>
					<?php } else { ?>
				...
				<div class="row mt-5">
					<div class="col-lg-12 title-page-here">
						<h4 class="pb-4 pt-4">
							<i class="fas fa-chevron-up" style="color: #f1c410;"></i> &nbsp Latest Airdrops
						</h4>
					</div>
