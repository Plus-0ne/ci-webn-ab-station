...
<head>
	...
	<meta name="description" content="WEBN Airdrops and Bounty Station">
  	<meta name="keywords" content="Crypto,WEBN,webn,Innovation,innovation,hydro auth,airdrops,bounty,airdrops and bounty,webn ph,webn innovation,web innvation ph,">
	<title>
		<?php echo $title;?>
	</title>
	<link rel="icon" href="<?=base_url()?>assets/users/img/3744.png" sizes="32x32" type="image/png">
